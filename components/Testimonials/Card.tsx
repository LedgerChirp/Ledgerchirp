...
export default function App() {
  return (
    <div className="h-screen w-[99%] mx-auto text-white">
      <Swiper
        navigation={true}
        modules={[Navigation]}
        className="mySwiper h-full w-[99%] flex justify-center items-center"
      >
        <SwiperSlide className="flex justify-center items-center text-center px-[30%] pt-[20%]">
